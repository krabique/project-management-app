...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post discussions_url, params: { discussion: { body: @discussion.body, creator: @discussion.creator, last_editor: @discussion.last_editor, project_id: @discussion.project_id, title: @discussion.title } }
    end
  ...
  test "should update discussion" do
    patch discussion_url(@discussion), params: { discussion: { body: @discussion.body, creator: @discussion.creator, last_editor: @discussion.last_editor, project_id: @discussion.project_id, title: @discussion.title } }
