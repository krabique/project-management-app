...
class WikisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wiki" do
    assert_difference('Wiki.count') do
      post wikis_url, params: { wiki: { body: @wiki.body, creator: @wiki.creator, last_editor: @wiki.last_editor, title: @wiki.title } }
    end
  ...
  test "should update wiki" do
    patch wiki_url(@wiki), params: { wiki: { body: @wiki.body, creator: @wiki.creator, last_editor: @wiki.last_editor, title: @wiki.title } }
